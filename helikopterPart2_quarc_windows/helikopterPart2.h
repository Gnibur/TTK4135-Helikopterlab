 ...
 */
#ifndef RTW_HEADER_helikopterPart2_h_
#define RTW_HEADER_helikopterPart2_h_
#ifndef helikopterPart2_COMMON_INCLUDES_
# define helikopterPart2_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helikopterPart2_COMMON_INCLUDES_ */

#include "helikopterPart2_types.h"
...
#define helikopterPart2_rtModel        RT_MODEL_helikopterPart2
...
} ContinuousStates_helikopterPart;
...
typedef struct {
  ...
  real_T TransferFcn4_CSTATE;          /* '<S2>/Transfer Fcn4' */
  real_T TransferFcn5_CSTATE;          /* '<S2>/Transfer Fcn5' */
} StateDerivatives_helikopterPart;
...
#define rtB                            helikopterPart2_B
#define BlockIO                        BlockIO_helikopterPart2
#define rtX                            helikopterPart2_X
#define ContinuousStates               ContinuousStates_helikopterPart
#define rtP                            helikopterPart2_P
#define Parameters                     Parameters_helikopterPart2
#define rtDWork                        helikopterPart2_DWork
#define D_Work                         D_Work_helikopterPart2

/* Parameters (auto storage) */
struct Parameters_helikopterPart2_ {
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<S1>/Saturation'
                                        */
  real_T Saturation_UpperSat_o;        /* Expression: 50*pi/180
                                        * Referenced by: '<S3>/Saturation'
                                        */
  real_T Saturation_LowerSat_h;        /* Expression: -50*pi/180
                                        * Referenced by: '<S3>/Saturation'
                                        */
...
struct RT_MODEL_helikopterPart2 {
  const char_T *path;
...
extern Parameters_helikopterPart2 helikopterPart2_P;

/* Block signals (auto storage) */
extern BlockIO_helikopterPart2 helikopterPart2_B;

/* Continuous states (auto storage) */
extern ContinuousStates_helikopterPart helikopterPart2_X;

/* Block states (auto storage) */
extern D_Work_helikopterPart2 helikopterPart2_DWork;

/* Model entry point functions */
extern void helikopterPart2_initialize(boolean_T firstTime);
extern void helikopterPart2_output(int_T tid);
extern void helikopterPart2_update(int_T tid);
extern void helikopterPart2_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_helikopterPart2 *helikopterPart2_M;
 ...
 *
 * '<Root>' : helikopterPart2
 * '<S1>'   : helikopterPart2/Elevasjonskontroller
 * '<S2>'   : helikopterPart2/Heli 3D
 * '<S3>'   : helikopterPart2/Pitch-kontroller
 * '<S4>'   : helikopterPart2/V_d//V_s --> V_f//V_b
 */
#endif                                 /* RTW_HEADER_helikopterPart2_h_ */
