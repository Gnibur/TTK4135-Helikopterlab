...
typedef helikopterExercise4_last_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
extern RT_MODEL * helikopterExercise4_last(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(helikopterExercise4_last_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://helikopterExercise4_last:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: helikopterExercise4_last -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
