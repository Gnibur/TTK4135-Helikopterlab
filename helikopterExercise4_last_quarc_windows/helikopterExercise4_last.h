 ...
 */
#ifndef RTW_HEADER_helikopterExercise4_last_h_
#define RTW_HEADER_helikopterExercise4_last_h_
#ifndef helikopterExercise4_last_COMMON_INCLUDES_
# define helikopterExercise4_last_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <math.h>
#include <string.h>
...
#endif                                 /* helikopterExercise4_last_COMMON_INCLUDES_ */

#include "helikopterExercise4_last_types.h"
...
#define helikopterExercise4_last_rtModel RT_MODEL_helikopterExercise4_la
...
typedef struct {
  ...
  real_T Sat;                          /* '<S2>/Sat' */
} BlockIO_helikopterExercise4_las;
...
} D_Work_helikopterExercise4_last;
...
#define rtB                            helikopterExercise4_last_B
#define BlockIO                        BlockIO_helikopterExercise4_las
#define rtX                            helikopterExercise4_last_X
#define ContinuousStates               ContinuousStates_helikopterExer
#define rtP                            helikopterExercise4_last_P
#define Parameters                     Parameters_helikopterExercise4_
#define rtDWork                        helikopterExercise4_last_DWork
#define D_Work                         D_Work_helikopterExercise4_last
...
struct Parameters_helikopterExercise4__ {
  ...
  real_T Saturation_UpperSat_d;        /* Expression: 50*pi/180
                                        ...
                                        */
  real_T Saturation_LowerSat_c;        /* Expression: -50*pi/180
                                        * Referenced by: '<S4>/Saturation'
                                        */
...
struct RT_MODEL_helikopterExercise4_la {
  const char_T *path;
...
extern Parameters_helikopterExercise4_ helikopterExercise4_last_P;

/* Block signals (auto storage) */
extern BlockIO_helikopterExercise4_las helikopterExercise4_last_B;

/* Continuous states (auto storage) */
extern ContinuousStates_helikopterExer helikopterExercise4_last_X;

/* Block states (auto storage) */
extern D_Work_helikopterExercise4_last helikopterExercise4_last_DWork;

/* Model entry point functions */
extern void helikopterExercise4_last_initialize(boolean_T firstTime);
extern void helikopterExercise4_last_output(int_T tid);
extern void helikopterExercise4_last_update(int_T tid);
extern void helikopterExercise4_last_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_helikopterExercise4_la *helikopterExercise4_last_M;
 ...
 *
 * '<Root>' : helikopterExercise4_last
 * '<S1>'   : helikopterExercise4_last/Elevasjonskontroller
 * '<S2>'   : helikopterExercise4_last/Heli 3D
 * '<S3>'   : helikopterExercise4_last/LQ controller
 * '<S4>'   : helikopterExercise4_last/Pitch-kontroller
 * '<S5>'   : helikopterExercise4_last/V_d//V_s --> V_f//V_b
 */
#endif                                 /* RTW_HEADER_helikopterExercise4_last_h_ */
