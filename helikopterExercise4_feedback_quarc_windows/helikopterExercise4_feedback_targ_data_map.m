  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (helikopterExercise4_feedback_P)
    ;%
      section.nData     = 45;
      section.data(45)  = dumData; %prealloc
      
	  ;% helikopterExercise4_feedback_P.HILInitialize_OOStart
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_OOEnter
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_OOTerminate
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_OOExit
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_AILow
	  ...
	  ;% helikopterExercise4_feedback_P.KalibrerElev_Gain
	  ...
	  ;% helikopterExercise4_feedback_P.KalibrerPitch_Gain
	  ...
	  ;% helikopterExercise4_feedback_P.VandringDeriv_C
	  section.data(21).logicalSrcIdx = 22;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helikopterExercise4_feedback_P.VandringDeriv_D
	  ...
	  ;% helikopterExercise4_feedback_P.TransferFcn4_C
	  section.data(24).logicalSrcIdx = 26;
	  section.data(24).dtTransOffset = 23;
	
	  ;% helikopterExercise4_feedback_P.TransferFcn4_D
	  ...
	  ;% helikopterExercise4_feedback_P.Saturation_UpperSat_k
	  ...
	  ;% helikopterExercise4_feedback_P.K_pd_Gain
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_CKChannels
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_EIInitial
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_AIChannels
	  section.data(1).logicalSrcIdx = 53;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_AOChannels
	  section.data(2).logicalSrcIdx = 54;
	  section.data(2).dtTransOffset = 16;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_EIQuadrature
	  section.data(3).logicalSrcIdx = 55;
	  section.data(3).dtTransOffset = 20;
	
	  ;% helikopterExercise4_feedback_P.HILReadEncoder_Channels
	  section.data(4).logicalSrcIdx = 56;
	  section.data(4).dtTransOffset = 21;
	
	  ;% helikopterExercise4_feedback_P.HILWriteAnalog_Channels
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_Active
	  section.data(1).logicalSrcIdx = 58;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_CKPStart
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_AIPStart
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_AOPStart
	  ...
	  ;% helikopterExercise4_feedback_P.HILInitialize_AOStart
	  section.data(8).logicalSrcIdx = 65;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_AOEnter
	  section.data(9).logicalSrcIdx = 66;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_AOTerminate
	  section.data(10).logicalSrcIdx = 67;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_AOExit
	  section.data(11).logicalSrcIdx = 68;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_AOReset
	  section.data(12).logicalSrcIdx = 69;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOPStart
	  section.data(13).logicalSrcIdx = 70;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOPEnter
	  section.data(14).logicalSrcIdx = 71;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOStart
	  section.data(15).logicalSrcIdx = 72;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOEnter
	  section.data(16).logicalSrcIdx = 73;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOTerminate
	  section.data(17).logicalSrcIdx = 74;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOExit
	  section.data(18).logicalSrcIdx = 75;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOReset
	  section.data(19).logicalSrcIdx = 76;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_EIPStart
	  section.data(20).logicalSrcIdx = 77;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_EIPEnter
	  section.data(21).logicalSrcIdx = 78;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_EIStart
	  section.data(22).logicalSrcIdx = 79;
	  section.data(22).dtTransOffset = 21;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_EIEnter
	  section.data(23).logicalSrcIdx = 80;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_POPStart
	  section.data(24).logicalSrcIdx = 81;
	  section.data(24).dtTransOffset = 23;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_POPEnter
	  section.data(25).logicalSrcIdx = 82;
	  section.data(25).dtTransOffset = 24;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_POStart
	  section.data(26).logicalSrcIdx = 83;
	  section.data(26).dtTransOffset = 25;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_POEnter
	  section.data(27).logicalSrcIdx = 84;
	  section.data(27).dtTransOffset = 26;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_POTerminate
	  section.data(28).logicalSrcIdx = 85;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_POExit
	  section.data(29).logicalSrcIdx = 86;
	  section.data(29).dtTransOffset = 28;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_POReset
	  section.data(30).logicalSrcIdx = 87;
	  section.data(30).dtTransOffset = 29;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_OOReset
	  section.data(31).logicalSrcIdx = 88;
	  section.data(31).dtTransOffset = 30;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOInitial
	  section.data(32).logicalSrcIdx = 89;
	  section.data(32).dtTransOffset = 31;
	
	  ;% helikopterExercise4_feedback_P.HILInitialize_DOFinal
	  section.data(33).logicalSrcIdx = 90;
	  section.data(33).dtTransOffset = 32;
	
	  ;% helikopterExercise4_feedback_P.HILReadEncoder_Active
	  section.data(34).logicalSrcIdx = 91;
	  section.data(34).dtTransOffset = 33;
	
	  ;% helikopterExercise4_feedback_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (helikopterExercise4_feedback_B)
    ;%
      section.nData     = 8;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (helikopterExercise4_feedb_DWork)
    ;%
      section.nData     = 6;
      section.data(6)  = dumData; %prealloc
      
	  ;% helikopterExercise4_feedb_DWork.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopterExercise4_feedb_DWork.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 16;
	
	  ;% helikopterExercise4_feedb_DWork.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 32;
	
	  ;% helikopterExercise4_feedb_DWork.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 36;
	
	  ;% helikopterExercise4_feedb_DWork.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 40;
	
	  ;% helikopterExercise4_feedb_DWork.HILWriteAnalog_Buffer
	  section.data(6).logicalSrcIdx = 5;
	  ...
	  ;% helikopterExercise4_feedb_DWork.ToFile_PWORK.FilePtr
	  section.data(1).logicalSrcIdx = 6;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopterExercise4_feedb_DWork.HILReadEncoder_PWORK
	  ...
	  ;% helikopterExercise4_feedb_DWork.ToWorkspace_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 10;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helikopterExercise4_feedb_DWork.elevasion_output_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 11;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helikopterExercise4_feedb_DWork.pitch_output_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 12;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helikopterExercise4_feedb_DWork.travel_PWORK.LoggedData
	  ...
	  ;% helikopterExercise4_feedb_DWork.Elevasjon_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 16;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helikopterExercise4_feedb_DWork.Pitch_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 17;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helikopterExercise4_feedb_DWork.Vandring_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 18;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helikopterExercise4_feedb_DWork.Bakmotorvolts_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 19;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helikopterExercise4_feedb_DWork.Frontmotorvolt_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 20;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helikopterExercise4_feedb_DWork.HILWriteAnalog_PWORK
	  ...
	  ;% helikopterExercise4_feedb_DWork.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 22;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopterExercise4_feedb_DWork.HILReadEncoder_Buffer
	  ...
	  ;% helikopterExercise4_feedb_DWork.ToFile_IWORK.Count
	  section.data(1).logicalSrcIdx = 25;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helikopterExercise4_feedb_DWork.ToFile1_IWORK.Count
	  section.data(2).logicalSrcIdx = 26;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helikopterExercise4_feedb_DWork.ToFile2_IWORK.Count
	  section.data(3).logicalSrcIdx = 27;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helikopterExercise4_feedb_DWork.u_star_IWORK.PrevIndex
	  section.data(4).logicalSrcIdx = 28;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helikopterExercise4_feedb_DWork.x_star_IWORK.PrevIndex
  ...
  targMap.checksum0 = 21000766;
  targMap.checksum1 = 3298841055;
  targMap.checksum2 = 3763219128;
  targMap.checksum3 = 1228058123;
