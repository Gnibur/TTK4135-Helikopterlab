/*
 * helikopterExercise4_feedback.h
 *
 ...
 */
#ifndef RTW_HEADER_helikopterExercise4_feedback_h_
#define RTW_HEADER_helikopterExercise4_feedback_h_
#ifndef helikopterExercise4_feedback_COMMON_INCLUDES_
# define helikopterExercise4_feedback_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <math.h>
#include <string.h>
...
#endif                                 /* helikopterExercise4_feedback_COMMON_INCLUDES_ */

#include "helikopterExercise4_feedback_types.h"
...
#define helikopterExercise4_feedback_rtModel RT_MODEL_helikopterExercise4_fe
...
typedef struct {
  ...
  real_T Sat;                          /* '<S2>/Sat' */
} BlockIO_helikopterExercise4_fee;
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } u_star_PWORK;                      /* '<Root>/u_star' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } x_star_PWORK;                      /* '<Root>/x_star' */
  ...
  struct {
    int_T PrevIndex;
  } u_star_IWORK;                      /* '<Root>/u_star' */

  struct {
    int_T PrevIndex;
  } x_star_IWORK;                      /* '<Root>/x_star' */
} D_Work_helikopterExercise4_feed;
...
} ContinuousStates_helikopterExer;
...
} StateDisabled_helikopterExercis;
...
#define rtB                            helikopterExercise4_feedback_B
#define BlockIO                        BlockIO_helikopterExercise4_fee
#define rtX                            helikopterExercise4_feedback_X
#define ContinuousStates               ContinuousStates_helikopterExer
#define rtP                            helikopterExercise4_feedback_P
#define Parameters                     Parameters_helikopterExercise4_
#define rtDWork                        helikopterExercise4_feedb_DWork
#define D_Work                         D_Work_helikopterExercise4_feed

/* Parameters (auto storage) */
struct Parameters_helikopterExercise4__ {
  ...
  real_T Saturation_UpperSat_k;        /* Expression: 50*pi/180
                                        ...
                                        */
  real_T Saturation_LowerSat_l;        /* Expression: -50*pi/180
                                        * Referenced by: '<S4>/Saturation'
                                        */
...
struct RT_MODEL_helikopterExercise4_fe {
  const char_T *path;
...
extern Parameters_helikopterExercise4_ helikopterExercise4_feedback_P;

/* Block signals (auto storage) */
extern BlockIO_helikopterExercise4_fee helikopterExercise4_feedback_B;

/* Continuous states (auto storage) */
extern ContinuousStates_helikopterExer helikopterExercise4_feedback_X;

/* Block states (auto storage) */
extern D_Work_helikopterExercise4_feed helikopterExercise4_feedb_DWork;

/* Model entry point functions */
extern void helikopterExercise4_feedback_initialize(boolean_T firstTime);
extern void helikopterExercise4_feedback_output(int_T tid);
extern void helikopterExercise4_feedback_update(int_T tid);
extern void helikopterExercise4_feedback_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_helikopterExercise4_fe *helikopterExercise4_feedback_M;
 ...
 *
 * '<Root>' : helikopterExercise4_feedback
 * '<S1>'   : helikopterExercise4_feedback/Elevasjonskontroller
 * '<S2>'   : helikopterExercise4_feedback/Heli 3D
 * '<S3>'   : helikopterExercise4_feedback/LQ controller
 * '<S4>'   : helikopterExercise4_feedback/Pitch-kontroller
 * '<S5>'   : helikopterExercise4_feedback/V_d//V_s --> V_f//V_b
 */
#endif                                 /* RTW_HEADER_helikopterExercise4_feedback_h_ */
