 ...
 */
#ifndef RTW_HEADER_helikopterExercise3_h_
#define RTW_HEADER_helikopterExercise3_h_
#ifndef helikopterExercise3_COMMON_INCLUDES_
# define helikopterExercise3_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <math.h>
#include <string.h>
...
#endif                                 /* helikopterExercise3_COMMON_INCLUDES_ */

#include "helikopterExercise3_types.h"
...
#define helikopterExercise3_rtModel    RT_MODEL_helikopterExercise3
...
#define rtB                            helikopterExercise3_B
#define BlockIO                        BlockIO_helikopterExercise3
#define rtX                            helikopterExercise3_X
#define ContinuousStates               ContinuousStates_helikopterExer
#define rtP                            helikopterExercise3_P
#define Parameters                     Parameters_helikopterExercise3
#define rtDWork                        helikopterExercise3_DWork
#define D_Work                         D_Work_helikopterExercise3

/* Parameters (auto storage) */
struct Parameters_helikopterExercise3_ {
...
struct RT_MODEL_helikopterExercise3 {
  const char_T *path;
...
extern Parameters_helikopterExercise3 helikopterExercise3_P;

/* Block signals (auto storage) */
extern BlockIO_helikopterExercise3 helikopterExercise3_B;

/* Continuous states (auto storage) */
extern ContinuousStates_helikopterExer helikopterExercise3_X;

/* Block states (auto storage) */
extern D_Work_helikopterExercise3 helikopterExercise3_DWork;

/* Model entry point functions */
extern void helikopterExercise3_initialize(boolean_T firstTime);
extern void helikopterExercise3_output(int_T tid);
extern void helikopterExercise3_update(int_T tid);
extern void helikopterExercise3_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_helikopterExercise3 *helikopterExercise3_M;
 ...
 *
 * '<Root>' : helikopterExercise3
 * '<S1>'   : helikopterExercise3/Elevasjonskontroller
 * '<S2>'   : helikopterExercise3/Heli 3D
 * '<S3>'   : helikopterExercise3/LQ controller
 * '<S4>'   : helikopterExercise3/Pitch-kontroller
 * '<S5>'   : helikopterExercise3/V_d//V_s --> V_f//V_b
 */
#endif                                 /* RTW_HEADER_helikopterExercise3_h_ */
